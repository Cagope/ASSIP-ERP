...
import { RESIDENCIA_FISCAL_ROUTES } from './residencia-fiscal/residencia-fiscal.routes';
...
import { CONDICIONES_PROTECCION_ROUTES } from './condiciones-proteccion/condiciones-proteccion.routes';

/**
 * 🧩 Rutas principales — Módulo Hoja de Vida
 * ------------------------------------------------------------
 * Estructura base de navegación interna del módulo:
 *  - Formulario Integral (wizard)
 *  - CRUDs tradicionales
 *  - Módulo de impresiones
 */
export const HOJA_VIDA_ROUTES: Routes = [

  // 🟩 Flujo integral (wizard)
  {
    path: 'formulario-integral',
    children: FORMULARIO_INTEGRAL_ROUTES
  },
  ...
  {
    path: 'laborales',
    children: LABORALES_ROUTES
  },
  {
    path: 'financieros',
    children: FINANCIEROS_ROUTES
  },
  {
    path: 'datos-familiares',
    children: DATOS_FAMILIARES_ROUTES
  },
  {
    path: 'referencias-personales',
    children: REFERENCIAS_PERSONALES_ROUTES
  },
  {
    path: 'sarlaft',
    children: SARLAFT_ROUTES
  },
  {
    path: 'permisos-especiales',
    children: PERMISOS_ESPECIALES_ROUTES
  },
  {
    path: 'residencia-fiscal',
    children: RESIDENCIA_FISCAL_ROUTES
  },

  {
    path: 'condiciones-proteccion',
    children: CONDICIONES_PROTECCION_ROUTES
  },

  {
    path: 'apertura-cuentas',
    children: APERTURA_CUENTAS_ROUTES
  },
  {
    path: 'bienes-inmuebles',
    children: BIENES_INMUEBLES_ROUTES
  },
  {
    path: 'bienes-vehiculos',
    children: BIENES_VEHICULOS_ROUTES
  },
  {
    path: 'bienes-maquinaria',
    children: BIENES_MAQUINARIA_ROUTES
  },
  {
    path: 'bienes-inversiones',
    children: BIENES_INVERSIONES_ROUTES
  },

  // 🧾 Impresiones
  {
    path: 'impresiones',
    children: AFILIACION_ROUTES
  }
