...
@Component({
  selector: 'app-bienes-maquinaria-list',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './bienes-maquinaria-list.component.html',
  styleUrls: ['./bienes-maquinaria-list.component.scss']
})
export class BienesMaquinariaListComponent implements OnInit {
  ...
  gestionar(persona: DatosPersonales): void {
    ...
    this.router.navigate([
      '/hoja-vida/bienes-maquinaria/persona',
