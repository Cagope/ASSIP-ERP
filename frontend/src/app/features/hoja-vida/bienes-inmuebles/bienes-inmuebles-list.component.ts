...
@Component({
  selector: 'app-bienes-inmuebles-list',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './bienes-inmuebles-list.component.html',
  styleUrls: ['./bienes-inmuebles-list.component.scss']
})
export class BienesInmueblesListComponent implements OnInit {
  ...
  gestionar(persona: DatosPersonales): void {
    ...
    this.router.navigate([
      '/hoja-vida/bienes-inmuebles/persona',
