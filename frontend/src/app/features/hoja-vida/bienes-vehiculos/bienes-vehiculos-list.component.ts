...
@Component({
  selector: 'app-bienes-vehiculos-list',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './bienes-vehiculos-list.component.html',
  styleUrls: ['./bienes-vehiculos-list.component.scss']
})
export class BienesVehiculosListComponent implements OnInit {
  ...
  gestionar(persona: DatosPersonales): void {
    ...
    this.router.navigate([
      '/hoja-vida/bienes-vehiculos/persona',
