...
@Component({
  selector: 'app-aprobacion-bienes',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './aprobacion-bienes.component.html',
  styleUrl: './aprobacion-bienes.component.scss'
})
export class AprobacionBienesComponent {
  ...
  bienesPor(id:unknown):Record<string,unknown>[]{return this.items.filter(b=>b['id_solicitud_deudor']===id);}
  propietarios():unknown[]{return [...new Set(this.items.map(b=>b['id_solicitud_deudor']))];}
}
