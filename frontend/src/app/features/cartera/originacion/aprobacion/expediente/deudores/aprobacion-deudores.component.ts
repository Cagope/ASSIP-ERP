...
@Component({
  selector: 'app-aprobacion-deudores',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './aprobacion-deudores.component.html',
  styleUrl: './aprobacion-deudores.component.scss'
})
export class AprobacionDeudoresComponent {
