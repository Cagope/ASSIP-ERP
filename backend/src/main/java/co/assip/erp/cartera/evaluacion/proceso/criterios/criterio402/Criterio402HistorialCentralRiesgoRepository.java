...
public class Criterio402HistorialCentralRiesgoRepository {
    ...
    public List<Criterio402DatoDTO> obtenerDatos(
        ...
        String sql = """
                ...
                (
                    ...
                    (
                        ...
                        NULLIF(
                            UPPER(
                                TRIM(
                                    d.calificacion_guia_final
                                )
                            ),
                            ''
                        )
                            AS calificacion_guia_final
                ...
                SELECT
                    ...
                    dc.calificacion_guia_final
                        AS calificacionCentralRiesgo
