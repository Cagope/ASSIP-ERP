...
@NoArgsConstructor
@AllArgsConstructor
public class SolicitudCreditoGuardarRequestDTO {
     ...
     *
     * La selección es obligatoria, incluyendo la opción
     * "SIN FONDO DE GARANTÍAS".
     *
     * El porcentaje aplicado y el valor del fondo
     * son determinados por el backend.
     */
