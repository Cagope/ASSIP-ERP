...
public class TipoDocumento {
    ...
    public Boolean getTipoDv() {
        return tipoDv;
    }

    public void setTipoDv(Boolean tipoDv) {
        this.tipoDv = tipoDv;
    }

    public String getTipoDocumentoDian() {
        return tipoDocumentoDian;
    }

    public void setTipoDocumentoDian(String tipoDocumentoDian) {
        this.tipoDocumentoDian = tipoDocumentoDian;
    }
}
