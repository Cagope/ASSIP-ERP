...
public class SubZonasWriteController {

    private final SubZonaService service;
    private final UsuarioRepository usuarioRepository;

    public SubZonasWriteController(SubZonaService service, UsuarioRepository usuarioRepository) {
        this.service = service;
        this.usuarioRepository = usuarioRepository;
    }

    @PostMapping
    public ResponseEntity<Integer> create(@Valid @RequestBody SubZonaDTOs.SubZonaCreateRequest req) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> update(@PathVariable Integer id, @Valid @RequestBody SubZonaDTOs.SubZonaUpdateRequest req) {
        Integer userId = currentUserId();
