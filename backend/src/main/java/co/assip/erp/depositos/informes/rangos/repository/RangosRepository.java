package co.assip.erp.depositos.informes.rangos.repository;

import co.assip.erp.depositos.informes.rangos.RangosItemDTO;
import co.assip.erp.depositos.informes.rangos.RangosRequest;
...
public class RangosRepository {
    ...
    // ============================================================
    //  BASE SQL — con AGENCIA y FECHA CORTE
    // ============================================================
    private static final String BASE_SQL = """
        ...
        base AS (
            SELECT
                ...
                (COALESCE(m.total_debitos,0) - COALESCE(m.total_creditos,0)) AS saldo,
    ...
    // ============================================================
    //  CONSULTA POR EDAD (AÑOS)
    // ============================================================
    public List<RangosItemDTO> consultarPorEdad(RangosRequest req) {
        ...
        for (int i = 0; i < rs.size(); i++) {
            ...
            if (i < rs.size() - 1) filtros.append(" OR ");
    ...
    //  CONSULTA POR SALDO
    // ============================================================
    public List<RangosItemDTO> consultarPorSaldo(RangosRequest req) {
    ...
    // ============================================================
    //  CONSULTA POR ANTIGÜEDAD (AÑOS → MESES)
    // ============================================================
    public List<RangosItemDTO> consultarPorAntiguedad(RangosRequest req) {
    ...
    // ============================================================
    // PARAMS BASE (agencia + fechaCorte)
    // ============================================================
    private Map<String, Object> baseParams(RangosRequest req) {
        Map<String, Object> p = new HashMap<>();
        p.put("agencia", req.getAgencia());
    ...
    // MAPEO DTO
    // ============================================================
    private RangosItemDTO mapRow(java.sql.ResultSet rs, int rowNum) throws java.sql.SQLException {
