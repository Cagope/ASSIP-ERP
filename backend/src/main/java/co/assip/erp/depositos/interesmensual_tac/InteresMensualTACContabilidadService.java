...
public class InteresMensualTACContabilidadService {
    ...
    public void registrarComprobante(
        ...
        for (InteresMensualTACItemDTO item : lista) {
        ...
        origen.setProcesoOrigen("INTERES_MENSUAL_TAC");
